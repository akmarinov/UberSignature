#
#  Be sure to run `pod spec lint UberSignature.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Mimicking pen-on-paper signatures with a touch screen presents a difficult set of challenges."
...
![Signature Demo](sign.gif)
  ...
  s.source       = { :git => "https://github.com/akmarinov/UberSignature.git", :tag => "#{s.version}" }
